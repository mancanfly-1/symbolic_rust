#
# WARNING: This file has been automatically generated from o.rust/a.ll
#
...
def _init_globals(ctx,):
  ...
  irpy.declare_global_constant(ctx,'@alloc3',itypes.parse_type(ctx,'<{ [8 x i8] }>*'),irpy.constant_struct(ctx,itypes.parse_type(ctx,'<{ [8 x i8] }>'),'<{ [8 x i8] c"src/a_rs" }>',),itypes.parse_type(ctx,'<{ [8 x i8] }>'))
  irpy.declare_global_constant(ctx,'@alloc4',itypes.parse_type(ctx,'<{ i8*, [16 x i8] }>*'),irpy.constant_struct(ctx,itypes.parse_type(ctx,'<{ i8*, [16 x i8] }>'),'<{ i8* getelementptr inbounds (<{ [8 x i8] }>, <{ [8 x i8] }>* @alloc3, i32 0, i32 0, i32 0), [16 x i8] c"\08\00\00\00\00\00\00\00\0F\00\00\00\05\00\00\00" }>',),itypes.parse_type(ctx,'<{ i8*, [16 x i8] }>'))
...
def func_add(ctx,arg1,arg2,):
  ...
  def bb_start(pred,):
    ...
    irpy.debug_loc(ctx,'%0','src/a.rs:15:5',)
...
def _init_metadata(ctx,):
  ...
  irpy.declare_metadata(ctx, '!3','!DIFile(filename: "src/a.rs", directory: "/home/mancanfly/Downloads/hv6/test_rust/test1", checksumkind: CSK_MD5, checksum: "e216e937b8d6cec3bd7e7ee77b8278e6")')
  ...
  irpy.declare_metadata(ctx, '!11','!DIFile(filename: "src/a.rs", directory: "/home/mancanfly/Downloads/hv6/test_rust/test1")')
